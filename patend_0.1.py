...
USPTO_API_KEY = "1hqK2bo5.LS50G5gOKs9lqra4cGOb3sRwb3DDPklG"

# Helper function to query PatentsView API
def get_patentsview_patents(query, max_results=10):
    """
    Fetches patent information from the PatentsView API.
    ...
    try:
        response = requests.get(PATENTSVIEW_API_URL, params=params)
...
def main():
    ...
    if st.button("Collect Patents"):
        if query:
            ...
            patents = get_patentsview_patents(query, max_results=10)
